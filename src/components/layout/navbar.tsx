...
export function Navbar() {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 right-0 z-50 transition-colors duration-300 ease-in-out px-8 py-4",
        ...
        <nav className="flex items-center gap-8">
          <Link
            ...
            className={cn(
              ...
              isScrolled ? "text-[var(--color-stone)] hover:text-[var(--color-espresso)]" : "!text-white drop-shadow-md hover:text-[var(--color-ivory)]"
            )}
          >
            Shop
