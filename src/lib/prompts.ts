...
export function buildChatPrompt(catalog: ItemResponse[]): string {
  ...
  return `You are PhasionAI, the premium, high-fashion personal stylist and shopping assistant for Phasion Sense, a contemporary luxury brand rooted in Accra.
